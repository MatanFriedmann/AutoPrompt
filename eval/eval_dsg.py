...
class DSG:
    ...
    def get_source_image_questions(self):
        print("in src question gen")
        print(self.source_images, 'DEBUG: src img')
        for i, filename in enumerate(os.listdir(self.source_images)):
            ...
            if filename.lower().endswith(('.png', '.jpg', '.jpeg', '.tiff', '.bmp', '.gif')):
                try:
                    ...
                    print('src_questions', src_questions)
                except Exception as e:
                        print(f"Failed to process {filename}: {e}")
        print('self res', self.results)
        # paes
        return
    ...
    def generate_dsg(self, prompts):
        ...
        print(self.results, 'DEBUG_results')
        print(inputs, 'inputs')
    ...
    def create_qna_prompts(self, dataset: pd.DataFrame):
         ...
         for key in self.results.keys():
            ...
            print(dependencies)
            print(self.results[key]['question'])
            print(answers)
